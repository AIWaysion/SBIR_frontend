...
SOUTH_ZONES = {
    #"entry_zone_0": [[15.17, 465.13], [44.97, 441.96], [53.24, 381.54], [30.1, 396.4]],
    "entry_zone_1": [
        [385.24, 528.44],
        [513.35, 448.0],
        [466.67, 392.39],
    ...
    "entry_zone_2": [[322.7, 420.2], [433.3, 351.9], [465.0, 390.0], [347.5, 467.86]],
    "entry_zone_3": [[300.2, 376.7], [321.79, 419.9], [434.2, 350.73], [406.8, 321.9]],
    "dilemma_zone_5": [
        [513.24, 445.1],
        [960.14, 147.17],
        [934.9, 139.7],
    ...
    "dilemma_zone_6": [[438.6, 352.7], [911.1, 133.1], [934.2, 139.2], [467.8, 391.98]],
    "dilemma_zone_7": [[894.2, 125.4], [408.9, 322.6], [436.8, 351.3], [912.2, 132.2]],
    #"dilemma_zone_8": [[1.6, 426.7], [23.91, 405.5], [93.76, 209.14], [81.8, 212.7]],
    #"dilemma_zone_9": [[0.8, 423.5], [80.98, 212.73], [72.2, 215.5], [0.76, 375.96]],
    #"entry_zone_10": [[0.7, 476.7], [12.3, 466.3], [24.63, 405.62], [0.7, 430.0]],
    #"dilemma_zone_11": [[29.9, 395.5], [55.04, 378.36], [103.3, 206.7], [94.5, 209.5]],
}
zones = SOUTH_ZONES
...
def detect(save_img=False, line_thickness=1):
    ...
    source = 'rtsp://wowza01.bellevuewa.gov:1935/live/CCTV047S.stream'
    weights = 'weights/yolov7-e6e.pt'
    save_img = not opt.nosave and not source.endswith(".txt")  # save inference images
    webcam = 'rtsp://wowza01.bellevuewa.gov:1935/live/CCTV047S.stream'
    save_crop = True
